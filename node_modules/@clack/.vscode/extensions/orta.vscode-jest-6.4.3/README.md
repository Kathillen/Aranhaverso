...
## Releases 
- **Current** ([v6.4.3](https://github.com/jest-community/vscode-jest/releases/tag/v6.4.3)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v6.md#v643)
